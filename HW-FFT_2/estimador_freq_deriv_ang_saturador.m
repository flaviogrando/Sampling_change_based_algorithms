...
function [freq_final] = estimador_freq_deriv_ang_saturador(phi0, phi1, phi2, f0, Fs, ref_seg, m, N)
...
%         if desvio_fase(j,i) > 0.008
%             desvio_fase(j,i) = 0.008;
%         elseif desvio_fase(j,i) < -0.008
%             desvio_fase(j,i) = -0.008;
%         end
